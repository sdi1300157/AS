...
public class LineGraph {
	...
	private TimeSeries series1 = new TimeSeries(" Light data"); 
	...
	public LineGraph()
	{
		...
		mRenderer.setXTitle("\nTime (ms)");
		mRenderer.setYTitle("   Light values (lux)");
		mRenderer.setShowGrid(false);
		//mRenderer.setGridColor(Color.LTGRAY);
		mRenderer.setZoomEnabled(false);
		////   mRenderer.setYAxisMin(-5.0);
		////   mRenderer.setYAxisMax(250.0);
		...
		mRenderer.setMargins(new int[] {140, 65, 100, 10});
	...
	{
		series1.add(p.getX(), LightGraph.xx);
