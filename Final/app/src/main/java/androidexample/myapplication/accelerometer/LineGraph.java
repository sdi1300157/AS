...
public class LineGraph {
	...
	public LineGraph()
	{
		...
		mRenderer.setXTitle("\nTime (ms)");
		mRenderer.setYTitle("   X-Y-Z axes values (m/s\u00B2)");
		mRenderer.setShowGrid(false);
		//mRenderer.setGridColor(Color.LTGRAY);
		mRenderer.setZoomEnabled(false);
		mRenderer.setYAxisMin(-20.0);
		mRenderer.setYAxisMax(20.0);
	...
	{
		series1.add(p.getX(), AcceleroGraph.xx);
		series2.add(p.getX(), AcceleroGraph.yy);
		series3.add(p.getX(), AcceleroGraph.zz);
