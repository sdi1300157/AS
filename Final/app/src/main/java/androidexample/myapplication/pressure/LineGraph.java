...
public class LineGraph {
	...
	private TimeSeries series1 = new TimeSeries(" Pressure data"); 
	...
	public LineGraph()
	{
		...
		mRenderer.setXTitle("\nTime (ms)");
		mRenderer.setYTitle("   Pressure values (mBar)");
		mRenderer.setShowGrid(false);
		//mRenderer.setGridColor(Color.LTGRAY);
		mRenderer.setZoomEnabled(false);
	////   mRenderer.setYAxisMin(995.0);
	////   mRenderer.setYAxisMax(1005.0);
		...
		mRenderer.setMargins(new int[] {140, 75, 100, 10});
	...
	{
		series1.add(p.getX(), PressureGraph.xx);
